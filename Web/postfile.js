...
function startUpload()
{
 ...
 var currentAction = dialogform.getAttribute('action');
 dialogform.setAttribute('action', currentAction + '&submit=' + encodeURIComponent(document.pressed));     // To allow detection of the press of special buttons

 if ((typeof ProgressBar != 'undefined') && (typeof ProgressBar[UploadId] != 'undefined')) ProgressBar[UploadId].ShowBar(true);
...
function uploadDone()
{
 ...
 if (responseJS != '') {
  ...
  if ((typeof UploadId != 'undefined') && (typeof ProgressBar != 'undefined') && (typeof ProgressBar[UploadId] != 'undefined')) ProgressBar[UploadId].ShowBar(false);
  // Run the javascript
  eval(responseJS);
 }
}
...
function updateProgress(progressXML, AJAXstatus, progressText)
{
 ...
 if ((typeof ProgressBar != 'undefined') && (typeof ProgressBar[UploadId] != 'undefined')) ProgressBar[UploadId].UpdateBar(percent);
